function myFunction() {
  ...
  document.getElementById("eglise").innerHTML = "Saint-Aignan, de kerk";
  document.getElementById("placeDucale").innerHTML = "Charleville-Mézières, het hertogelijk plein";
...
function Français() {
  ...
  document.getElementById("placeDucale").innerHTML = "Charleville-Mézières, la place ducale";
