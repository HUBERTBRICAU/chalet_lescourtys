function Neerlandais() {
  ...
  // document.getElementById("clickSurPhoto").innerHTML = "Klik op de foto voor kaarten";
...
function Français() {
  ...
  // document.getElementById("clickSurPhoto").innerHTML = "Cliquer sur la photo pour maps";
